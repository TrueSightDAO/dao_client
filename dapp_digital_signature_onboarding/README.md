...
Canonical column layout (header row **1**, 1-based): **A** Contributor Name, **B** Created time stamp, **C** Last Active time stamp, **D** Status, **E** Digital Signature (SPKI base64), **F** Email, **G** Verification Key, **H** Verification Key Consumed. See **[tokenomics/SCHEMA.md](https://github.com/TrueSightDAO/tokenomics/blob/main/SCHEMA.md)** → section **Contributors Digital Signatures**.
...
```bash
cd dapp_digital_signature_onboarding
